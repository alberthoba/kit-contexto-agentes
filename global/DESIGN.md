...
> **Recordatorio técnico**: ningún agente auto-carga `DESIGN.md`. En Claude Code, importarlo desde `CLAUDE.md` / `AGENTS.md` con `@DESIGN.md` (la sintaxis se resuelve y carga el archivo). Como alternativa universal, un puntero explícito en el archivo principal: "para temas de diseño visual, lee `DESIGN.md`".
