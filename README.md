...
Un kit sencillo que sujeta a cualquier agente a tu identidad, tu forma de trabajar y el contexto del proyecto — sin tener que reescribirlo cada vez.
...
ln -s ../../AGENTS.md .cursor/rules/agents.mdc
```
...
Este repositorio está basado en el trabajo original de Álvaro Sánchez:

https://github.com/genteinvencible/arnes-agentes

Se han realizado pequeñas adaptaciones para facilitar su uso como plantilla reutilizable en proyectos personales.
